...
void DiskDriver_init(DiskDriver* disk, const char* filename, int num_blocks){
		...
		//dai blocchi del disco ne tolgo uno che è quello allocato per il diskHeader
...
int DiskDriver_readBlock(DiskDriver* disk, void* dest, int block_num){
	...
	//trasformo il blocco che devo andare a leggere in due indici di una BitMapEntryKey
